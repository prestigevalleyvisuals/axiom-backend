  ...
  try {
    const r = await fetch('https://api.telnyx.com/v2/calls', {
      ...
      body: JSON.stringify({
        ...
        from: telnyxNumber,
        webhook_url: `${process.env.RAILWAY_PUBLIC_DOMAIN ? 'https://' + process.env.RAILWAY_PUBLIC_DOMAIN : 'https://axiom-backend-production-0618.up.railway.app'}/webhooks/telnyx`,
